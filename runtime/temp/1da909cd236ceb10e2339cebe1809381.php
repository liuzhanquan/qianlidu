<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy\WWW\lanHu\application/manage\view\product\product_edit.html";i:1570523874;s:57:"D:\phpstudy\WWW\lanHu\application\manage\view\layout.html";i:1570500128;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="container">
   ...
   38:                 </select>
	        ...
	        <dl>
	            ...
	            <dd style="">
	            	<div class="search-item" style="position:relative;height:20px;">
						<input type="text" class="form-control" name="start_time" style="width: 150px;float:left;position:absolute;left:0px;" value="<?php if($info['id'] != 0): ?><?php echo date("Y-m-d H:i:s",$info['start_time']); else: ?><?php echo date('Y-m-d H:i:s',time()); endif; ?>" data-model="form-time" readonly=""><em style="float:left;margin-top:5px;position:absolute;left:160px;width:10px;">--</em>
						<input type="text" class="form-control" name="stop_time" style="width: 150px;float:left;position:absolute;left:190px;" value="<?php if($info['id'] != 0): ?><?php echo date("Y-m-d H:i:s",$info['stop_time']); else: ?><?php echo date('Y-m-d H:i:s',time()); endif; ?>"" data-model="form-time" readonly="">
					</div>
	            </dd>
	        </dl>
	        <dl>
	        ...
	        <dl>
	            ...
	            <dd style="">
	            	<div class="search-item" style="position:relative;height:20px;">
						<input type="text" class="form-control" name="show_time" style="width: 150px;float:left;position:absolute;left:0px;" value="<?php if($info['id'] != 0): ?><?php echo date("Y-m-d H:i:s",$info['show_time']); else: ?><?php echo date('Y-m-d H:i:s',time()); endif; ?>"" data-model="form-time" readonly=""><em style="float:left;margin-top:5px;position:absolute;left:160px;width:10px;">--</em>
						<input type="text" class="form-control" name="hide_time" style="width: 150px;float:left;position:absolute;left:190px;" value="<?php if($info['id'] != 0): ?><?php echo date("Y-m-d H:i:s",$info['hide_time']); else: ?><?php echo date('Y-m-d H:i:s',time()); endif; ?>"" data-model="form-time" readonly="">
					</div>
	            </dd>
	        </dl>
	        <dl>
