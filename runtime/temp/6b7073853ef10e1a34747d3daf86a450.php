<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpstudy\WWW\lanHu\application/manage\view\agentcard\card_edit.html";i:1570609934;s:57:"D:\phpstudy\WWW\lanHu\application\manage\view\layout.html";i:1570500128;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="container">
	...
	<div class="sys-content">
		<form data-model="form-submit">
	        ...
	        <dl>
	            <dt>密码：</dt>
	            <dd>
	            	<input type="text" class="form-controls" name="password"  value="<?php echo $info['password']; ?>">
	            </dd>
	        </dl>
	        <dl>
	            <dt>卡片类型：</dt>
	            <dd>
	            	<label class="radio-inline"><input type="radio" class="card_type" name="card_type" <?php if($info['card_type'] == 1): ?>checked<?php endif; ?> value="1">虚拟卡</label>
	            	<label class="radio-inline"><input type="radio" class="card_type" name="card_type" <?php if($info['card_type'] == 2): ?>checked<?php endif; ?> value="2">实体卡</label>
	            	<!-- <em>元</em>
	            	<i>（支持2位小数点）</i> -->
	            	<div class="tip-alert"></div>
	            </dd>
	        </dl>
			<dl class="print_box" <?php if($info['card_type'] == 1): ?>style="display:none"<?php endif; ?>>
	            <dt>是否印刷：</dt>
	            <dd>
	            	<label class="radio-inline"><input type="radio" name="print_status" <?php if($info['print_status'] == 1): ?>checked<?php endif; ?> value="1">已印刷</label>
	            	<label class="radio-inline"><input type="radio" name="print_status" <?php if($info['print_status'] == 0): ?>checked<?php endif; ?> value="0">未印刷</label>
	            	<!-- <em>元</em>
	            	<i>（支持2位小数点）</i> -->
	            	<div class="tip-alert"></div>
	            </dd>
   ...
   36                      <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $info['card_style']): ?>selected="selected"<?php endif; ?>><?php echo $item['name']; ?></option>
   ...
   38:                 </select>
			...
			<dl>
	            <dt>是否使用（激活）：</dt>
	            <dd>
	            	<label class="radio-inline"><input type="radio" name="card_state" <?php if($info['card_state'] == 1): ?>checked<?php endif; ?> value="1">已激活</label>
	            	<label class="radio-inline"><input type="radio" name="card_state" <?php if($info['card_state'] == 0): ?>checked<?php endif; ?> value="0">未激活</label>
	            	<!-- <em>元</em>
	            	<i>（支持2位小数点）</i> -->
	            	<div class="tip-alert"></div>
	            </dd>
			...
			<dl>
	            <dt>当天试密码次数：</dt>
	            <dd>
	            	<input type="text" class="form-controls" name="up_num" value="<?php echo $info['up_num']; ?>">
	            </dd>
	        </dl>
			<dl>
	            <dt>代理商：</dt>
   ...
   36                      <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $info['gid']): ?>selected="selected"<?php endif; ?>><?php echo $item['name']; ?></option>
   37                      <?php endforeach; endif; else: echo "" ;endif; ?>
   38:                 </select>
	            	<i></i>
	            	<div class="tip-alert"></div>
			...
			<dl>
	            ...
	            <dd style="position:relative;">
	            	<input type="text" class="form-controls" name="charge_time" value="<?php echo $info['charge_time_num']; ?>">
					<select name="charge_type" class="form-control" style="width: 150px;float:left;position:absolute;left:200px;height:33px;background-color:#fff;top:0px;" id="ddlAgentLevel_<?php echo $vo['id']; ?>">
						<option value="31104000" <?php if($info['charge_time'] > 31104000): ?>selected="selected"<?php endif; ?>>年</option>
						<option value="2592000" <?php if($info['charge_time'] < 31104000): ?>selected="selected"<?php endif; ?>>月</option>
						<option value="86400" <?php if($info['charge_time'] < 2592000): ?>selected="selected"<?php endif; ?>>天</option>
						<option value="3600" <?php if($info['charge_time'] < 86400): ?>selected="selected"<?php endif; ?>>小时</option>
					</select>
	            </dd>
	        </dl>
			<dl>
	            <dt>是否启用：</dt>
	            <dd>
	            	<?php $state = isset($info['state']) ? $info['state'] : '0'; ?>
	            	<label class="radio-inline"><input type="radio" name="state" <?php if($state == 1): ?>checked<?php endif; ?> value="1">启用</label>
	            	<label class="radio-inline"><input type="radio" name="state" <?php if($state == 0): ?>checked<?php endif; ?> value="0">冻结</label>
	            </dd>
	        </dl>
