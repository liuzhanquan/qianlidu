<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\phpstudy\WWW\lanHu\application/manage\view\system\doaccount.html";i:1557097924;s:57:"D:\phpstudy\WWW\lanHu\application\manage\view\layout.html";i:1570500128;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="bar-title">
		<ol class="breadcrumb">
		  ...
		  <li><a href="javascript:;">系统设置</a></li>
  		  ...
  		  <li><?php if($id > 0): ?>修改子账号<?php else: ?>添加子账号<?php endif; ?></li>
		</ol>
	</div>
	<div class="sys-content">
		<form data-model="form-submit">
	        ...
	        <dl>
	            <dt><i>*</i>角色权限：</dt>
	            <dd>
	            	<select name="role_id" class="select" data-model="form-select" style="width: 262px!important" datatype="*">
	                    <option value="">请选择</option>
	                    <?php foreach($list as $vo): ?>
						<option value="<?php echo $vo['gid']; ?>" <?php if($info['role_id'] == $vo['gid']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
						<?php endforeach; ?>
	                </select>
	        ...
	        <dl>
	            <dt><i>*</i>手机：</dt>
	            <dd>
	            	<input type="text" style="width: 270px" name="phone" class="form-controls" datatype="m" value="<?php echo $info['phone']; ?>">
	            	<i>11位手机号码</i>
	            	<div class="tip-alert"></div>
	            </dd>
	        </dl>
